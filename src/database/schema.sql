...
CREATE TABLE IF NOT EXISTS positions (
    ...
    mint TEXT NOT NULL,
    platform TEXT NOT NULL,
    entry_net_price_decimal REAL NOT NULL,  -- Net price from TradeResult.net_price_decimal()
    token_decimals INTEGER NOT NULL,  -- Value of 10 ** TOKEN_DECIMALS
    total_token_swapin_amount_raw INTEGER NOT NULL,  -- Total tokens bought
    total_token_swapout_amount_raw INTEGER NOT NULL,  -- Total tokens sold (accumulation)
    entry_ts INTEGER NOT NULL,  -- Unix epoch milliseconds
    exit_strategy TEXT NOT NULL,  -- Exit strategy from config
    ...
    transaction_fee_raw INTEGER NOT NULL DEFAULT 0,  -- Accumulated fees
    platform_fee_raw INTEGER NOT NULL DEFAULT 0,  -- Accumulated fees
